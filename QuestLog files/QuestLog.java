	...
	public void saveQuests() {
      ...
      BufferedWriter bufferedWriter = new BufferedWriter(writer);
            ...
            for(Quest q: questLog) {
            	...
            	string.append((q.getDate().getYear() + 1900) + ",");//4
            	string.append((q.getDate().getMonth()+ 1 )+ ",");//5
            	string.append(q.getDate().getDate()+",");//6
